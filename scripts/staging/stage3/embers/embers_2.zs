...
print("~~~ Begin Stage 3 Embers Staging ~~~");

var stageString = stages.Embers3.stage;
...
for item in Stage3EmbersMagicItems
{
  mods.ItemStages.removeItemStage(item);
  scripts.helpers.setItemAndRecipesStage(item, stageString);
}

print("### Stage 3 Embers Complete ###");
