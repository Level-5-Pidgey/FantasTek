...
var DenseAndPoorOres as crafttweaker.item.IItemStack[crafttweaker.item.IItemStack] =
{
	...
	//Overworld Poor Ores
		...
		<contenttweaker:sub_block_holder_14:14> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_11:10> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_11:11> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_11:13> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_1:2> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_1:9> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_1:14> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_0:1> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_0:13> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_10> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_10:8> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_3:1> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_3:6> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_3:9> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_3:11> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_3:13> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_2:10> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_5:15> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_4:2> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_4:10> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_4:14> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_7:5> : <minecraft:cobblestone>,
		<contenttweaker:sub_block_holder_7:14> : <minecraft:cobblestone>,
...
var ExtraMaterialsToStage as mods.zenstages.Stage[string] =
{
  ...
  "Rhodochrosite" : stages.progression2,
  "BoronNitride" : stages.progression2,
  "Fluorite" : stages.progression2,
  "Villiaumite" : stages.progression2,
  "Carobbiite" : stages.progression2,
  "Manganese" : stages.progression2,
  "ManganeseDioxide" : stages.progression2,
  "ManganeseOxide" : stages.progression2,
  "CarbonManganese" : stages.progression2,
  "LithiumManganeseDioxide" : stages.progression2,
  "HSLASteel" : stages.progression2,
  "Beryllium" : stages.progression2,
...
var extraOreDicts as mods.zenstages.Stage[IOreDictEntry] =
{
	...
	<ore:boneWither> : stages.progression1,
};
