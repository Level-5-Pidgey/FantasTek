...
recipes.addShapeless(scripts.helpers.createRecipeName(<ore:dustCrudeSteel>.firstItem), <ore:dustCrudeSteel>.firstItem * 2, [<ore:dustIron>, <ore:dustIron>, <contenttweaker:coke_dust>, <ore:dustObsidian>]);
