...
recipes.addShaped(scripts.helpers.createRecipeName(<appliedenergistics2:grindstone>), <appliedenergistics2:grindstone>, [[<ore:cobblestone>, <ore:gearWood>, <ore:cobblestone>], [<ore:cobblestone>, <ore:plateQuartz>, <ore:cobblestone>], [<ore:cobblestone>, <ore:obsidian>, <ore:cobblestone>]]);
