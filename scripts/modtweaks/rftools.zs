...
val rftoolsRecipes_EXTENDEDCRAFTING = {
	<rftools:elevator> : [[<ore:ingotConductiveIron>, <ore:enderpearl>, <ore:ingotConductiveIron>], [<ore:ingotConductiveIron>, scripts.helpers.CircuitTiers[1], <ore:ingotConductiveIron>], [<ore:ingotConductiveIron>, <ore:ingotPulsatingIron>, <ore:ingotConductiveIron>]],
