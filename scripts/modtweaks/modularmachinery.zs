...
{
	<liquid:lifeessence> : 50000,
};

for burnItem, powerOutput in BloodMagicPlant
{
	var BloodMagicPowerProduction = RecipeBuilder.newBuilder("bloodmagic_converter" ~ burnItem.displayName, "bloodmagic_converter", 20);
	BloodMagicPowerProduction.addFluidInput(burnItem * 50);
	BloodMagicPowerProduction.addEnergyPerTickOutput(powerOutput / (20 * 50));
...
mods.extendedcrafting.TableCrafting.addShaped(0, <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:embers_converter"}), [[null, <embers:ancient_motive_core>, null], [<embers:brick_caminite>, <enderio:item_material:77>, <embers:brick_caminite>], [null, <embers:brick_caminite>, null]]);
//Embers Mechanical Assembler
recipes.addShaped(scripts.helpers.createRecipeName(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:ember_assembly_plant"})) ~ "_emberAssembly", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:ember_assembly_plant"}), [[<embers:shard_ember>, <embers:shard_ember>, <embers:shard_ember>], [<embers:plate_caminite>, <enderio:item_material:77>, <embers:plate_caminite>], [null, <ore:craftingTableWood>, null]]);
//Industrial Mixer
recipes.addShaped(scripts.helpers.createRecipeName(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:industrial_mixer"})) ~ "_industrialMixer", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:industrial_mixer"}), [[null, scripts.helpers.MotorTiers[1], null], [scripts.helpers.MotorTiers[1], <enderio:item_material:77>, scripts.helpers.MotorTiers[1]], [null, scripts.helpers.FrameTiers[1], null]]);
//Mechanical Imbuer
recipes.addShaped(scripts.helpers.createRecipeName(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:mechanical_imbuer"})) ~ "_mechanicalimbuer", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:mechanical_imbuer"}), [[<ore:dustBlizz>, null, <ore:dustBlitz>], [scripts.helpers.CircuitTiers[1], <enderio:item_material:77>, scripts.helpers.CircuitTiers[1]], [<ore:dustBasalz>, null, <contenttweaker:magma_powder>]]);
//Assembly Line
recipes.addShaped(scripts.helpers.createRecipeName(<modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:assembly_line"})) ~ "_assembly_line", <modularmachinery:itemblueprint>.withTag({dynamicmachine: "modularmachinery:assembly_line"}), [[null, scripts.helpers.CircuitTiers[2], null], [scripts.helpers.CircuitTiers[2], <enderio:item_material:77>, scripts.helpers.CircuitTiers[2]], [<thermalfoundation:material:512>, scripts.helpers.FrameTiers[1], <thermalfoundation:material:512>]]);
//Ore Washing Factory
